...
- Jobs-to-be-Done (JTBD): Customers “hire” products to make progress in a situation; focus on outcomes, not demographics.
- Pain, Desire, Risk: Decisions balance pain relief and desired gain versus perceived risk (money, time, status).
- Motivations: Functional, emotional, and social jobs. Emotional risk often blocks adoption even when ROI is clear.
- Heuristics & Biases: Loss aversion, social proof, authority, anchoring, and friction costs shape buying.
- Buying committee: In B2B, multiple roles (economic buyer, champion, users, security) with different psych drivers.
...
- Mistake: Feature-first messaging. Fix: Outcome-first headlines using customer words.
- Mistake: Ignoring anxiety/friction. Fix: Add security/IT artifacts, implementation timelines, and concierge onboarding.
- Mistake: One-size-fits-all. Fix: Persona-specific pages and nurture tracks.

## 5. Hands-on Exercises

- Guided: Conduct 3 JTBD interviews and highlight exact phrases to reuse in copy.
- Guided: Create a 1-page objection handling sheet for the top persona.
- Challenge: Redesign your onboarding to reduce time-to-first-value by 50%.
