...
- One-sentence formula: For [ICP/persona] who need [job/outcome], [brand] is a [category] that [unique promise], unlike [alternative], because [reason to believe].
- Message pyramid:
  - Top: Core promise
...
- Mistake: Jargon-heavy, vague promises. Fix: Use JTBD language and measurable outcomes.
- Mistake: No differentiation. Fix: Name your category or unique mechanism; contrast with status quo.
- Mistake: Proof buried. Fix: Put logos/metrics above the fold; link to deep dives.
