# Sales & Marketing Learning Path for Engineers
### ⚙️ Phase 1: Foundations (Weeks 1–4)

**Goal:** Build your mental model of what “sales and marketing” really mean in a tech/product context.
**Topics:**

* Difference between Sales, Marketing & Growth
* Core Customer Psychology
* Building a Personal/Brand Value Proposition
...
* Copywriting for Engineers
* Content Marketing (blogs, video, email, SEO)
* Storytelling in Tech Marketing
...
* Cold Emailing, Outreach, and CRM tools
* Sales Calls & Objection Handling
* Lead Qualification (BANT, MEDDIC)
* Follow-ups & Closing Techniques
...
* Building a Marketing Engine for Your Projects
* Social Selling (LinkedIn, Twitter/X)
* AI Tools for Sales & Marketing Automation
* Freelancing / SaaS Selling Strategy
...
When you give me a topic, I’ll respond with:
