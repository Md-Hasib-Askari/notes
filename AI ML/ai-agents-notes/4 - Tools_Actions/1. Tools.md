Awesome! Now we’re entering the **core enabler of AI agent power** — tools! Let’s break down **Section 4: Tools / Actions 🛠️**, which covers how agents interact with the outside world beyond just generating text.
